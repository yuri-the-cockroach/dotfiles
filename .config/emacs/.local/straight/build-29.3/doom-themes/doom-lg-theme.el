;;; doom-lg-theme.el --- Port of Monokai Pro -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-lg-theme nil
  "Options for the `doom-lg' theme."
  :group 'doom-themes)

(defcustom doom-lg-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-lg
  "A port of VS Code's Monokai Pro"

  ;; name        gui       256       16
  ((bg         '("#181818" nil       nil          ))
   (bg-alt     '("#1f1f1f" nil       nil          ))
   (base0      '("#282828" "black"   "black"      ))
   (base1      '("#1b1b1b" "#1B1B1B"              ))
   (base2      '("#181818" "#212122"              ))
   (base3      '("#242424" "#2B2B2B" "brightblack"))
   (base4      '("#333842" "#3F4040" "brightblack"))
   (base5      '("#4d5154" "#5C5E5E" "brightblack"))
   (base6      '("#9ca0a4" "#757878" "brightblack"))
   (base7      '("#b1b1b1" "#969896" "brightblack"))
   (base8      '("#F8F8F8" "#FCFCFA" "white"      ))
   (fg         '("#FCFCFA" "#939293" "white"))
   (fg-alt     '("#939293" "#A3A2A3" "white"))

   (grey       '("#8f908a" "#727072" "brightblack"))
   (red        '("#e95678" "#CC6666" "red"))
   (orange     '("#fd971f" "#FC9867" "orange"))
   (green      '("#a6e22e" "#A9DC76" "green"))
   (teal       green)
   (yellow     '("#e6db74" "#FFD866" "yellow"))
   (blue       '("#78DCE8" "#78DCE8" "blue"))
   (dark-blue  '("#81A2BE" "#81A2BE" "blue"))
   (magenta    '("#FF6188" "#FF6188" "violet"))
   (violet     '("#ae81ff" "#AB9DF2" "violet"))
   (cyan       blue)
   (dark-cyan  dark-blue)
   ...
   (-modeline-pad
    (when doom-lg-padded-modeline
      (if (integerp doom-lg-padded-modeline)
          doom-lg-padded-modeline
        4))))
...
(provide 'doom-lg-theme)
;;; doom-lg-theme.el ends here
